...
var Card = /*#__PURE__*/function () {
  ...
  _createClass(Card, [{
    ...
    key: "idCard",
    value: function idCard() {
      return this._data._id;
    }
  }, {
    key: "_likeVisibl",
    value: function _likeVisibl() {
      var _this2 = this;
    ...
    key: "_trashVisiblButton",
    value: function _trashVisiblButton() {
...
var PopupWithDialog = /*#__PURE__*/function (_Popup) {
  ...
  _createClass(PopupWithDialog, [{
    key: "open",
    value: function open(cardCallback) {
...
var Section = /*#__PURE__*/function () {
  ...
  _createClass(Section, [{
    ...
    key: "prependCard",
    value: function prependCard(card) {
...
/* harmony import */ var _components_PopupWithDialog__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/PopupWithDialog */ "./src/components/PopupWithDialog.js");
...
var editButtonSave = document.querySelector('.popup__save-button_edit');
/**Переменные для Add */
var addBtn = document.querySelector('.profile__add-button');
var submitPopupAdd = document.querySelector('.popup-add__form');
var addButton = document.querySelector('.popup__save-button_add');
...
/**переменные для авы*/
var addAvatar = document.querySelector('.profile__avatar');
var submitPopupAvatar = document.querySelector('.popup-avatar__form');
var avatarButton = document.querySelector('.popup__save-button_avatar');
...
api.getUserInfo().then(function (userInfoData) {
...
//удаляем карточку
var popupWithDialog = new _components_PopupWithDialog__WEBPACK_IMPORTED_MODULE_9__.PopupWithDialog('.popup-delete');
function handleDeleteCard(card) {
  popupWithDialog.open(function () {
    api.deleteCard(card.idCard()).then(function () {
      card.removeCard();
...
function handleLikeCard(card) {
  api.setLike(card.idCard()).then(function (res) {
    card.setLikes(res);
  }).catch(function (err) {
    console.log(err);
  });
...
function handleDeleteLikeCard(card) {
  api.delLike(card.idCard()).then(function (res) {
    card.setLikes(res);
  }).catch(function (err) {
    console.log(err);
  });
...
var avatarForm = new _components_FormValidator_js__WEBPACK_IMPORTED_MODULE_2__.FormValidator(submitPopupAvatar, validationConfig);
